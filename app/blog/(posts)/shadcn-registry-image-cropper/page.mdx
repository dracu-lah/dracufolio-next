...
<Figure
  src="/appwrite/projects/image-cropper.png"
  alt="The image-cropper demo page twice: on the left the empty dropzone, on the right an image loaded with the crop box over it"
  width={1940}
  height={893}
  caption="The demo page in the two states that took the time. On the left the empty dropzone, carrying the ratio and the size limit it was given; on the right the crop box over a loaded image, with the discard and upload controls that only exist once there is something to send."
/>
