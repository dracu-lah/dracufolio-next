...
<Figure
  src="/appwrite/projects/resume-builder.png"
  alt="The Resume Builder editor, on the Personal tab, with fields for name, title, phone, website, email and a professional summary"
  width={965}
  height={625}
  caption="The editor. The tabs across the top are sections of the one object rather than separate documents, and the buttons above them load it from sample data or from a JSON file you already have."
/>
